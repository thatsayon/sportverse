...
const HeroSection = () => {
  return (
    <section className="bg-white">
      ...
      <div className="flex flex-col xl:flex-row xl:items-center gap-6 lg:gap-7 sm:-mt-4 md:mt-0 lg:mt-0 xl:-mt-10 min-h-[500px] sm:min-h-[600px] lg:h-[790px]">
        ...
        <div>
          ...
          <p className="max-w-full lg:max-w-[596px] text-base lg:text-lg sm:text-xl font-semibold text-[#808080] mt-4 lg:mt-0">
            From beginners to aspiring athletes, we provide step-by-step
            training, skill development, and mentorship to help you succeed in
            sports
          </p>
          
          {/* CTA Button - keep original styling */}
          <Button className="mt-6 px-8">Join Academy</Button>
          
          {/* First Image - keep original dimensions for lg+, responsive for smaller */}
          <div className="border-2 w-full max-w-full lg:max-w-full lg:max-h-[435px] h-[250px] sm:h-[300px] lg:h-[435px] overflow-hidden relative rounded-2xl mt-8">
            <Image
