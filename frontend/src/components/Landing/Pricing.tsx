      ...
      <div className="">
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-600 leading-relaxed">
            Unlock your potential with our flexible subscription plans. Start with Basic or <br className="hidden md:block"/> 
          ...
          <p className="text-xs md:text-sm text-[#F15A24] flex items-center gap-2 bg-[#FFF2F2] w-fit px-4 rounded-full py-2.5 md:font-medium mt-4">
            <Star stroke="#D3A900" fill="#D3A900"/>Most athletes choose Pro for complete training access
          </p>
        </motion.div>
