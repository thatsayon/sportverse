    ...
    <section className="relative min-h-screen bg-gradient-to-b from-gray-100 to-white">
      <form onSubmit={handleSubmit} className="space-y-6">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0.7)), url('https://res.cloudinary.com/dn4ygnsfg/image/upload/v1760122914/contact_sybx2j.jpg')`,
          }}
        />
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 lg:py-24">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Ready to elevate your soccer training? Have questions about Ball
              Mastery? We're here to help you on your journey.
            </p>
          </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-gray-700 hover:text-[#F15A24] transition-colors break-all"
                      >
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <a
                        href="https://www.ballmastery.com"
                        target="_blank"
            ...
            <div className="bg-white/40 backdrop-blur-sm border border-white/20 rounded-lg p-6 lg:p-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  >
                    <option value="athlete" className="bg-gray-200 text-black">
                      Athlete/Student
                    </option>
                    <option value="trainer" className="bg-gray-200 text-black">
                      Trainer/Coach
                    </option>
                    <option value="parent" className="bg-gray-200 text-black">
                      Parent/Guardian
                    </option>
                    <option
                      value="organization"
                ...
                {submitStatus === "error" && (
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-center space-x-3">
                    ...
                    <p className="text-red-800 text-sm">
                      ...
                      directly at train@brightstarsoccer.com
                    </p>
                  </div>
                )}
